...
{% set columns = [
    ...
    {"name": "last_browser_name", "datatype": dbt_utils.type_string()},
    {"name": "last_browser_version", "datatype": dbt_utils.type_string()},
    {"name": "last_operating_system", "datatype": dbt_utils.type_string()},
    {"name": "last_server_name", "datatype": dbt_utils.type_string()},
    {"name": "last_updated_at", "datatype": dbt_utils.type_timestamp()},
    {"name": "last_user_agent", "datatype": dbt_utils.type_string()},
    {"name": "last_visit", "datatype": dbt_utils.type_timestamp()},
    {"name": "n_id", "datatype": dbt_utils.type_string()}
] %}
